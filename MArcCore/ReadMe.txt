========================================================================
    STATIC LIBRARY : MArcCore Project Overview
========================================================================

AppWizard has created this MArcCore library project for you.

This file contains a summary of what you will find in each of the files that
make up your MArcCore application.
...
StdAfx.h, StdAfx.cpp
    ...
    named MArcCore.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "MArcCore.rc" and a "MArcCore.h" that
