...
public:
  ...
  enum bundleType
  {
    btSingleFile = 0, // Uncompressed, unchanged file
    btZipFile    = 1  // Compressed file in ZIP format
  };
...
// Extract the file given by strGetFile from the Bundle and write it into strWriteToFilename file
