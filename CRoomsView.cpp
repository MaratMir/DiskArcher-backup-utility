// DiskArcher.
// Implementation of the CRoomsView class.
...
/////////////////////////////////////////////////////////////////////////////
// CRoomsView construction/destruction
...
//	lpCreateStruct->dwExStyle |= ; // Это не работает, а работает SetExtendedStyle
...
/* Так почему-то не получилось, пришлось делать SetItemState
	// State M
